...
void inicializa(){//Inicializa a matriz no início do programa
    ...
    movimentar();
    imprimir();
    puts("O jogo come�ar� em 2 segundos!");
    sleep(2);
}
...
void fileHelperW(char tecla) { //Helper de file, para escrever as posi��es do doce e cobra respectivamente no arquivo settings
	FILE *arq;
	int i, j;
