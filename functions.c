...
void fileHelper() {
	...
	arq = fopen("settings.txt", "wt");  // Cria um arquivo texto para grava��o
	
	fprintf(arq, "Posi��o X: %d Posi��o Y: %d Vida do Doce: %d\n",candy.position.x,candy.position.y,candy.life); //Gravando estado do doce, posi��o X,Y e vida do doce respectivamente
	fprintf(arq, "Posi��o X: %d Posi��o Y: %d Tamanho da Cobra: %d",*snake.p,*snake.p,snake.size);
